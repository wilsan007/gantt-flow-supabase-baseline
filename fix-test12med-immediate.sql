-- ==============================================
-- Script de réparation pour l'utilisateur test12med@yahoo.com
-- ==============================================
...
DECLARE
  ...
  target_user_email TEXT := 'test12med@yahoo.com';
  target_user_id UUID := '645c5dba-2930-49a5-a75d-9f7304dc3790';
  target_full_name TEXT := 'Test 12 Med';
