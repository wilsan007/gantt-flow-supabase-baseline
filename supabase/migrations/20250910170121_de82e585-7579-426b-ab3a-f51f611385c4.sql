...
-- 2. Générer des données complètes d'attendance pour les 30 derniers jours
WITH 
...
-- Insérer les attendances pour les employés présents (sans total_hours qui est calculé automatiquement)
