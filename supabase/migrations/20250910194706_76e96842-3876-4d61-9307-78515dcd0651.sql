-- Add sample data to training_enrollments table (using valid employee and training IDs)
...
-- Add sample data to timesheets table (using valid employee, task and project IDs)  
INSERT INTO timesheets (employee_id, task_id, project_id, date, hours, description, billable, approved, approved_by) VALUES
('650e8400-e29b-41d4-a716-446655440001', '3dd8c548-6393-4755-a405-bb6c5e177068', 'b2b3cf81-f994-4367-91de-10895e64fe95', '2024-01-05', 8, 'Développement interface utilisateur', true, true, 'Admin User'),
('650e8400-e29b-41d4-a716-446655440002', 'f5ae1645-e34c-4e08-be18-4d666cce9aae', 'c5ffe07c-a3c7-4a6d-89dd-375b4bbc3b3b', '2024-01-05', 7, 'Gestion de projet et coordination équipe', true, true, 'Admin User'),
('650e8400-e29b-41d4-a716-446655440003', '46c853bc-657e-43d2-8798-bfcac716c012', '39527611-f1de-4758-8d3b-bbdf8fbd1257', '2024-01-06', 6, 'Campagne marketing digital', true, true, 'Admin User'),
('650e8400-e29b-41d4-a716-446655440004', '2111b5e8-2187-4a9d-b566-17c8487d9a0f', '85bef214-264c-4083-a1a9-c1648ceee0f9', '2024-01-07', 7, 'Analyse financière trimestrielle', true, false, NULL),
('650e8400-e29b-41d4-a716-446655440005', '24d58517-cf61-4030-90c1-93a69a49c0a9', 'f98337fc-e7d4-4d0b-b10a-165eac003705', '2024-01-12', 8, 'Développement API backend', true, true, 'Admin User'),
('650e8400-e29b-41d4-a716-446655440006', '3dd8c548-6393-4755-a405-bb6c5e177068', 'b2b3cf81-f994-4367-91de-10895e64fe95', '2024-01-12', 8, 'Administration système et DevOps', false, true, 'Admin User'),
('650e8400-e29b-41d4-a716-446655440007', 'f5ae1645-e34c-4e08-be18-4d666cce9aae', 'c5ffe07c-a3c7-4a6d-89dd-375b4bbc3b3b', '2024-01-13', 7, 'Recrutement et formation RH', false, true, 'Admin User'),
('650e8400-e29b-41d4-a716-446655440001', '46c853bc-657e-43d2-8798-bfcac716c012', '39527611-f1de-4758-8d3b-bbdf8fbd1257', '2024-01-19', 6, 'Tests et débogage interface', true, false, NULL),
('650e8400-e29b-41d4-a716-446655440002', '2111b5e8-2187-4a9d-b566-17c8487d9a0f', '85bef214-264c-4083-a1a9-c1648ceee0f9', '2024-01-20', 5, 'Réunion client et documentation', true, false, NULL),
('650e8400-e29b-41d4-a716-446655440003', '24d58517-cf61-4030-90c1-93a69a49c0a9', 'f98337fc-e7d4-4d0b-b10a-165eac003705', '2024-01-20', 8, 'Stratégie contenu et SEO', true, true, 'Admin User'),
('650e8400-e29b-41d4-a716-446655440004', '3dd8c548-6393-4755-a405-bb6c5e177068', 'b2b3cf81-f994-4367-91de-10895e64fe95', '2024-01-26', 7, 'Budgeting et prévisions', true, false, NULL),
('650e8400-e29b-41d4-a716-446655440005', 'f5ae1645-e34c-4e08-be18-4d666cce9aae', 'c5ffe07c-a3c7-4a6d-89dd-375b4bbc3b3b', '2024-01-27', 8, 'Optimisation base de données', true, true, 'Admin User'),
('650e8400-e29b-41d4-a716-446655440006', '46c853bc-657e-43d2-8798-bfcac716c012', '39527611-f1de-4758-8d3b-bbdf8fbd1257', '2024-02-02', 6, 'Maintenance serveurs', false, false, NULL),
('650e8400-e29b-41d4-a716-446655440007', '2111b5e8-2187-4a9d-b566-17c8487d9a0f', '85bef214-264c-4083-a1a9-c1648ceee0f9', '2024-02-02', 7, 'Entretiens et évaluations', false, false, NULL);
