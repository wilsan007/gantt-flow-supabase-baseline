-- Regenerate unique UUIDs for departments to ensure uniqueness
UPDATE public.departments SET id = gen_random_uuid() WHERE name = 'Ressources Humaines';
UPDATE public.departments SET id = gen_random_uuid() WHERE name = 'Développement';
UPDATE public.departments SET id = gen_random_uuid() WHERE name = 'Marketing';
UPDATE public.departments SET id = gen_random_uuid() WHERE name = 'Finance';
UPDATE public.departments SET id = gen_random_uuid() WHERE name = 'Commercial';
...
-- Add training enrollments (12+ rows)
