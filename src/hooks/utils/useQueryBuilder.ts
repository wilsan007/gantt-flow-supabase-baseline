...
export const useQueryBuilder = () => {
  ...
  const getComplexity = useCallback(
    (filters?: QueryFilters, isSuperAdmin?: boolean): 'simple' | 'medium' | 'complex' => {
