-- ==============================================
-- Script de réparation pour l'utilisateur med55test@yahoo.com
-- ==============================================
...
DECLARE
  ...
  target_user_email TEXT := 'med55test@yahoo.com';
  target_user_id UUID := '82bbe527-d560-4ad2-9d3a-048e5fc02e6e';
  target_full_name TEXT := 'Med 55 Test'; -- Nom par défaut, peut être ajusté
