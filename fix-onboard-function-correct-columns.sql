...
-- Utiliser les vraies colonnes de la table profiles
-- =====================================================
...
BEGIN
  ...
  -- Générer un employee_id unique (basé sur les IDs existants)
  ...
  -- Créer le profil utilisateur avec les vraies colonnes
  INSERT INTO profiles (
    id,                    -- Utiliser user_id comme id aussi
    user_id,
    tenant_id,
    full_name,
    email,
    employee_id,
    job_title,            -- Au lieu de position
    hire_date,
    contract_type,
    weekly_hours,
    role,                 -- Rôle dans le profil (différent de user_roles)
    created_at,
    updated_at
  ) VALUES (
    ...
    p_email,
    v_employee_id,
    'Propriétaire',       -- job_title
    CURRENT_DATE,
    'CDI',               -- contract_type
    35,                  -- weekly_hours standard
    'tenant_admin',      -- role dans le profil
    NOW(),
    NOW()
  );
  
  -- Assigner le rôle tenant_admin dans user_roles
...
-- =====================================================
-- FIN DE LA CORRECTION AVEC BONNES COLONNES
-- =====================================================
