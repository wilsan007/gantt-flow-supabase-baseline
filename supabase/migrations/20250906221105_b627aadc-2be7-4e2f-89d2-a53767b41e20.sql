-- Vérifier et créer tous les triggers d'audit manquants
...
-- Vérifier que tous les triggers sont bien créés
SELECT 
  schemaname,
  tablename,
  triggername,
...
WHERE n.nspname = 'public' 
  AND c.relname IN ('tasks', 'task_actions', 'task_comments', 'task_documents')
