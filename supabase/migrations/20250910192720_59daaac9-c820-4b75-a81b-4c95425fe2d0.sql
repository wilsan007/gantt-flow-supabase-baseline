-- Add more training programs with correct format values
...
('Cybersécurité avancée', 'Formation complète sur la sécurité informatique et la protection des données', 'Sécurité', 'online', 24, '2024-04-01', '2024-04-10', 25, 18, 'available', 'CyberSec Institute', 4.7),
