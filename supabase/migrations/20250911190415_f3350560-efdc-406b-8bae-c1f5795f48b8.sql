-- Corriger complètement la fonction log_task_change et nettoyer les tâches

-- Étape 1: D'abord corriger la fonction qui cause l'erreur
...
BEGIN
    ...
    IF TG_OP = 'UPDATE' THEN
        ...
        -- Utiliser assigned_name au lieu de assignee
